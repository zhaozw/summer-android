...
import cn.cerc.summer.android.parts.videobyvoice.mvtools.VMBaseActivity;
import cn.cerc.summer.android.parts.videobyvoice.mvtools.utils.VMLog;
import cn.cerc.summer.android.parts.videobyvoice.mvtools.utils.VMSPUtil;
import cn.cerc.summer.android.parts.videobyvoice.mvtools.widget.VMViewGroup;

/**
 * Created by Administrator on 2017/8/15.
 */

public class TextVideoActivity extends VMBaseActivity {
    ...
    private void callVideo() {
        checkContacts();
        Intent intent = new Intent(TextVideoActivity.this, VideoCallActivity.class);
    ...
    private void callVoice() {
        checkContacts();
        Intent intent = new Intent(TextVideoActivity.this, VoiceCallActivity.class);
        CallManager.getInstance().setChatId(contacts);
        CallManager.getInstance().setInComingCall(false);
    ...
    private void checkContacts() {
        ...
        if (contacts.isEmpty()) {
            Toast.makeText(TextVideoActivity.this, "constact user not null", Toast.LENGTH_LONG).show();
            return;
        }
