...
import cn.cerc.summer.android.parts.videobyvoice.mvtools.utils.VMDimenUtil;
...
public class FloatWindow {
    ...
    private void setupSurfaceView() {
        ...
        // 设置通话界面画面填充方式
        localView.setScaleMode(com.superrtc.sdk.VideoView.EMCallViewScaleMode.EMCallViewScaleModeAspectFill);
        oppositeView.setScaleMode(com.superrtc.sdk.VideoView.EMCallViewScaleMode.EMCallViewScaleModeAspectFill);
